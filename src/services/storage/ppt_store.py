...
def _project_row_to_dict(row: Any) -> dict[str, Any]:
    return {
        ...
        "style_preset_id": getattr(row, "style_preset_id", None),
        "style_custom_text": getattr(row, "style_custom_text", None),
        "template_image_path": row.template_image_path,
        "template_file_refs": getattr(row, "template_file_refs", None) or [],
        "reference_style_prompt": row.reference_style_prompt,
        "reference_layout_prompt": getattr(row, "reference_layout_prompt", None),
        "reference_content_prompt": getattr(row, "reference_content_prompt", None),
...
def create_project(
    *,
    ...
    stmt = ppt_projects.insert().values(
        ...
        template_file_refs=template_file_refs or [],
